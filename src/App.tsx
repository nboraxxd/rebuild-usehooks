...
export default function App() {
  ...
  return (
    <section>
      ...
      <button title="Sets the value to Lynn" className="link" onClick={() => setUser({ name: 'Lynn' })}>
        Lynn
      </button>
      <button title="Sets the value to Tyler" className="link" onClick={() => setUser({ name: 'Tyler' })}>
        Tyler
      </button>
      <button
